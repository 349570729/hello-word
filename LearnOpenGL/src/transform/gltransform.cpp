...
void transform::drawTria(GLFWwindow *window)
{
...
GLuint transform::createVertexShader()
{
...
GLuint transform::createFragmentShader()
{
	// ��Ƭ��ɫ��������ͬ������ɫ��
